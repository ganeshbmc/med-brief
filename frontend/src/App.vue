    ...
    <nav class="navbar navbar-expand-lg navbar-warm">
      <div class="container">
        <router-link class="navbar-brand d-flex align-items-center" :to="authStore.isAuthenticated ? '/dashboard' : '/'">
          <img src="@/assets/medbrief_icon.png" alt="MedBrief" class="me-2" style="height: 28px; background-color: var(--warm-50); border: 1px solid var(--warm-200); border-radius: 4px;" />
          <span>MedBrief</span>
        </router-link>
